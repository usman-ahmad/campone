$(document).on('turbolinks:load', function () {
    ...
    $('#discussion_private').change(function () {
        if (this.checked) {
            $('#private-discussions').show();
            $('.delete-user-from-discussion').prop('checked', true);
            return $('.include-user-or-not').prop('checked', false);
        } else {
            $('#private-discussions').hide();
            $('.delete-user-from-discussion').prop('checked', false);
            return $('.include-user-or-not').prop('checked', true);
        }
    });

    $('.include-user-or-not').change(function () {
        if (this.checked) {
            return $(this).siblings('.delete-user-from-discussion').prop('checked', false);
        } else {
            return $(this).siblings('.delete-user-from-discussion').prop('checked', true);
        }
    });
